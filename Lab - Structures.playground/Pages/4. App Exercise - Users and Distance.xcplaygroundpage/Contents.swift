 ...
 */
var justin = user(name: "Justin Wallen", age: 17, height: 5.10, weight: 190, activityLvl: 6)
print("Name: \(justin.name) \n Age: \(justin.age) \n Height: \(justin.height) \n Weight: \(justin.weight) \n Activity Level: \(justin.activityLvl)")
/*:
...
struct distance{
    ...
    init(metersToFeet:Double){
        meters = metersToFeet
        feet = meters * 3.28084
    }
    
    init(feetToMeters:Double){
        feet = feetToMeters
        meters = feet / 3.28084
    }
 ...
 */
var mile = distance(metersToFeet: 1600)
print(mile.feet)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var ft = distance(metersToFeet: 5249.344)
print(mile.meters)
