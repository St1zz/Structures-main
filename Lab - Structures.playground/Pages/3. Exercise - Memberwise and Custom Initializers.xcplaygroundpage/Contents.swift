...
struct Height{
    ...
    init(heightInInchesInit:Double){
    
        heightInInches = heightInInchesInit
        heightInCentimeters = heightInInchesInit * 2.54
    }
    
    init(heightInCentimetersInit:Double){
        
        heightInCentimeters = heightInCentimetersInit
        heightInInches = heightInCentimetersInit / 2.54
        
    }
}

let heightInch = Height(heightInCentimetersInit: 10)
print(heightInch.heightInInches)
/*:
